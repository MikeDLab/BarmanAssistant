					...
					<div>
						...
						<form action="app" method="post">
							<div class="form-group">
								<input type="hidden" name="command" value="Push_Ingredient" />
								<input type="text" class="edit" name="ingredient_name" id="name"
									placeholder=<fmt:message bundle="${locale}" key="name.placeholder" />
									maxlength="45">
								<textarea rows="10" cols="45" name="ingredient_description"
									maxlength="255"><fmt:message bundle="${locale}"
										key="addingredientpage.description" /></textarea>
