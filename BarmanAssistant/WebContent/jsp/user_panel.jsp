		...
		<div class="container">
			...
			<div style="float: left; width: 73%;">
				<blockquote>
					<div>
						<p>
							<fmt:message bundle="${locale}" key="user.login" />
							: ${User.userLogin}
						</p>
						<p>
							<fmt:message bundle="${locale}" key="user.name" />
							: ${User.userName}
						</p>
						<p>
							<fmt:message bundle="${locale}" key="user.email" />
							: ${User.userEmail}
						</p>
						<form action="app" method="post">
							<input type="hidden" name="command" value="AddCocktail" />
							<button type="submit">Cnage email</button>
						</form>
						<form action="app" method="post">
							<input type="hidden" name="command" value="AddCocktail" />
							<button type="submit">Cnage password</button>
						</form>
					</div>
				</blockquote>
			</div>
