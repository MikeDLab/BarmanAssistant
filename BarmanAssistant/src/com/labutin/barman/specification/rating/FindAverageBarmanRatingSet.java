...
public class FindAverageBarmanRatingSet implements RatingSpecification {
	private static Logger logger = LogManager.getLogger();
	private final static String FIND_BARMAN_RATING_SET_BY_USER_ID = "SELECT * FROM (Select user_id as barman_id From User) User  Inner Join BarmanRating Using(barman_id) Where barman_id = ?";
	private int userId;
