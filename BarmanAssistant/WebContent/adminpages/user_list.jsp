							...
							<table>
								<tr>
									...
									<th><fmt:message bundle="${locale}"
											key="user.averagerating" /></th>
									<th><fmt:message bundle="${locale}"
											key="user.cocktailnumber" /></th>
								</tr>
								<c:forEach items="${userSet}" var="userSet">
									...
									${userCocktailNumberMap.value}
										...
										<td><c:if test="${userSet.userRole == 2 }">
												<li class="active">
													<form action="MainServlet" method="post">
														...
														<button class="font-size" type="submit">
															<fmt:message bundle="${locale}" key="button.upgrade" />
														</button>
													</form>
												</li>
												...
												<li class="active">
													<form action="MainServlet" method="post">
														...
														<button class="font-size" type="submit">
															<fmt:message bundle="${locale}" key="button.downgrade" />
														</button>
													</form>
												</li>
											</c:if></td>
										<td><form action="MainServlet" method="post">
												...
												<button class="font-size" type="submit" onclick="return check();">Delete</button>
