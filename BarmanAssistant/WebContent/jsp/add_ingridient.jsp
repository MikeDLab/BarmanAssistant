		...
		<section>
			<blockquote>
				<div class="col-6 col-sm-3">
					<form action="MainServlet" method="post" name="AddIngredient">
						<div class="form-group">
							<input type="hidden" name="command" value="AddIngredient" /> <input
								type="text" class="edit" name="ingridientname" id="AddIngredient"
								placeholder="Inte name" maxlength="45">
							<textarea class="textarea" rows="10" cols="45" name="ingredientdesc" maxlength="255">Add descri</textarea>
