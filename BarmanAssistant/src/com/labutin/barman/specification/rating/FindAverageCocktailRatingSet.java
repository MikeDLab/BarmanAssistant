...
public class FindAverageCocktailRatingSet extends AbstractRatingSpecification implements RatingSpecification {
	private static final String FIND_COCKTAIL_RATING_SET_BY_USER_ID = "SELECT cocktail_id, user_id, cocktail_rating  FROM (Select cocktail_id as cocktail_id, user_id as emb_id FROM COCKTAIL) as Cocktail  INNER JOIN CocktailRating USING(cocktail_id) WHERE cocktail_id = ?";
